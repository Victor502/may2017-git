...
menu.Food.forEach(function (menuGroup, index, foodMenu) {
    console.log(menuGroup);
    table += '<table class="menu"><thead><tr><th colspan="2">';
    table += '<h4 class="menu-head red">' + menuGroup.name + '</h4>';
    table += '</th></tr></thead>';
    ...
    menuGroup.items.forEach(function(item) {
        ...
        table += '<td class="menu-price text-right">$' + item.price.toFixed(2) + '</td>';
        table += '</tr>';
    });
...
var tableContainer = document.querySelector('#foodmenu');
